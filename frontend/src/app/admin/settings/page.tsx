      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-8 space-y-8 scrollbar-custom">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-4xl font-black tracking-tighter uppercase italic">Control <span className="text-blue-500">Center</span></h2>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="xl:col-span-1 space-y-6">
              <div className="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center">
                  <div className="w-32 h-32 bg-linear-to-br from-blue-500 to-indigo-600 rounded-[2rem] p-1 shadow-2xl mb-6 ring-4 ring-slate-800/50">
                    <div className="w-full h-full bg-slate-900 rounded-[1.8rem] flex items-center justify-center text-4xl font-black italic text-blue-400">
                      {user.fullName.charAt(0)}
                    </div>
                  </div>
                  <h3 className="text-2xl font-black text-white mb-1 tracking-tight">{user.fullName}</h3>
                  <div className="bg-blue-600/10 border border-blue-500/20 px-4 py-1 rounded-full mb-8">
                    <span className="text-[10px] font-black uppercase text-blue-400 tracking-[0.2em]">{user.role}</span>
                  </div>

                  <div className="w-full space-y-4">
                    <div className="p-4 bg-slate-950 border border-slate-800 rounded-2xl flex items-center gap-4">
                      <div className="p-2 bg-slate-900 rounded-lg"><Globe className="w-4 h-4 text-slate-500" /></div>
                      <div className="overflow-hidden">
                        <p className="text-[9px] text-slate-600 font-bold uppercase tracking-widest leading-none mb-1">Email</p>
                        <p className="text-sm font-medium text-slate-300 truncate">{user.email}</p>
                      </div>
                    </div>
                    <div className="p-4 bg-slate-950 border border-slate-800 rounded-2xl flex items-center gap-4">
                      <div className="p-2 bg-slate-900 rounded-lg"><Monitor className="w-4 h-4 text-slate-500" /></div>
                      <div>
                        <p className="text-[9px] text-slate-600 font-bold uppercase tracking-widest leading-none mb-1">Dernière connexion</p>
                        <p className="text-sm font-medium text-slate-300">Aujourd'hui, 12:45</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-[2rem] p-6 shadow-xl space-y-4">
                <h4 className="text-xs font-black uppercase tracking-widest text-slate-500 ml-2">Sécurité</h4>
                <button 
                  onClick={() => setShowPasswordModal(true)}
                  className="w-full bg-slate-950 border border-slate-800 px-6 py-4 rounded-2xl hover:bg-slate-800 transition-all flex items-center justify-between group"
                >
                  <div className="flex items-center gap-3">
                    <Key className="w-4 h-4 text-slate-500 group-hover:text-blue-500" />
                    <span className="text-sm font-bold">Changer de mot de passe</span>
                  </div>
                  <ChevronRight className="w-4 h-4 text-slate-800" />
                </button>
                <button 
                  onClick={handleDeleteAccount}
                  className="w-full bg-slate-950 border border-slate-800 px-6 py-4 rounded-2xl hover:bg-slate-800 transition-all flex items-center justify-between group text-red-400"
                >
                  <div className="flex items-center gap-3">
            ...
            <div className="xl:col-span-2 space-y-8">
              <div className="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-10 shadow-2xl">
                <h3 className="text-2xl font-black text-white mb-10 tracking-tight italic flex items-center gap-3">
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        className="w-full bg-slate-950 border border-slate-800 rounded-2xl py-4 px-6 text-sm outline-none focus:ring-2 focus:ring-blue-500/20 transition-all shadow-inner"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        className="w-full bg-slate-950 border border-slate-800 rounded-2xl py-4 px-6 text-sm outline-none font-mono focus:ring-2 focus:ring-blue-500/20 transition-all shadow-inner"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-8">
                    <div className="flex items-center justify-between p-2">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-black text-white uppercase tracking-tight">Notifications Push</p>
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        />
                        <div className="w-12 h-6 bg-slate-800 rounded-full peer peer-checked:after:translate-x-6 after:content-[''] after:absolute after:top-[4px] after:left-[4px] after:bg-white after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-blue-600 shadow-inner"></div>
                      </label>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-2">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-black text-white uppercase tracking-tight">Mode Haute Sécurité</p>
                          <p className="text-[10px] text-slate-500 font-medium">Contrôle stricter des accès</p>
                        </div>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" defaultChecked className="sr-only peer" />
                        <div className="w-12 h-6 bg-slate-800 rounded-full peer peer-checked:after:translate-x-6 after:content-[''] after:absolute after:top-[4px] after:left-[4px] after:bg-white after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-emerald-500 shadow-inner"></div>
                      </label>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <select 
                        ...
                        className="w-full bg-slate-950 border border-slate-800 rounded-2xl py-4 px-6 text-sm outline-none focus:ring-2 focus:ring-blue-500/20 transition-all appearance-none cursor-pointer"
                      >
              ...
              <div className="bg-linear-to-br from-blue-600/5 to-indigo-600/5 border border-blue-500/10 rounded-[2.5rem] p-10 flex flex-col md:flex-row items-center gap-10">
                ...
                <div className="flex-1 space-y-2 text-center md:text-left">
                  <h4 className="text-xl font-black italic uppercase tracking-tighter">Support <span className="text-blue-400">Premium</span></h4>
                ...
                <button className="bg-white text-slate-950 px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-blue-50 transition-all active:scale-95 shadow-xl">
                  Contactez-nous
                </button>
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
          <div className="bg-slate-900 border border-slate-800 w-full max-w-md rounded-3xl p-8 shadow-2xl">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-xl font-black uppercase tracking-tight italic">Changer <span className="text-blue-500">Mot de Passe</span></h3>
